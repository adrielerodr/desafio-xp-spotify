import types from '@/features/search/actions/search.types';
import reducer from '@/features/search/actions/search.reducer';

describe('Search reducer test', function() {
  it('Should return a result for "Mars" search', function() {
    const state = {};
    let newState = reducer(state, {
      type:`${types.GET_ALBUMS}_FULFILLED`,
      payload: {
        albums: {
          items: [
            {
